...
Models train on a fixed token corpus and are evaluated by token-level perplexity
on four held-out sets: FineWeb-Edu, Wikipedia, TinyStories, and a math set held
out from OpenMathInstruct-2 (problem--solution pairs).
